...
func (_mock *MockUnitOfWork) Do(ctx context.Context, fn func(r auth.Repositories) error) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, func(r auth.Repositories) error) error); ok {
...
//   - ctx context.Context
//   - fn func(r auth.Repositories) error
...
func (_c *MockUnitOfWork_Do_Call) Run(run func(ctx context.Context, fn func(r auth.Repositories) error)) *MockUnitOfWork_Do_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 func(r auth.Repositories) error
		if args[1] != nil {
			arg1 = args[1].(func(r auth.Repositories) error)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockUnitOfWork_Do_Call) RunAndReturn(run func(ctx context.Context, fn func(r auth.Repositories) error) error) *MockUnitOfWork_Do_Call {
	_c.Call.Return(run)
	return _c
}
